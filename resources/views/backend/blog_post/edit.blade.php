                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                    ...
                                    <div class="col-sm-9 form-group text-secondary">
                                        <select class="form-select @error('category') is-invalid  @enderror" name ="category"  aria-label="Default select example">
                                         ...
                                         @foreach($cate as $Category)
                                            <option value="{{$Category->id}}"{{$Category->id == $blogPost->cat_id ? 'selected':''}}>{{$Category->cat_name}}</option>
                                           @endforeach
                                        </select>
                                        @error('category')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control @error('description') is-invalid  @enderror" name="description" id="product_descriptions" placeholder=""
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="mt-3">
                                            <img id="showImage" class="" height="150" width="200"
                                                src="{{ asset('uploads/blog/blog_post/'.$blogPost->image) }}" alt="category image">
                                        </div>
                                    </div>
