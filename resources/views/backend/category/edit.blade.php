                ...
                <div class="card-body">
                        <div class="border p-4 rounded">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="categoryName" class="form-control @error('categoryName') is-invalid  @enderror" id="inputEnterYourName"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                 ...
                                 <div class="mt-3">
                                    <img id="showImage" class="" height="150" width="200" src="{{ asset('uploads/category/'.$category->image) }}" alt="category image">
                                 </div>
                                </div>
                            </div>
                            <div class="row">
