            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="tpfaq__content mr-50">
                        ...
                        <p>Returns are free for orders shipped within the U.S. We include a UPS return label in every
                            package which is at no cost to use.</p>
                        <span>Follow the steps below for a seamless returns process:</span>
                        <ul>
                            <li>
                                – Please indicate a reason for return using one of the Return Codes listed on the order form
                                included in your package.
                            </li>
                            <li>
                                – Attach your UPS return label to the outside of the package. There is no cost to use this
                                label.
                            </li>
                            <li>
                                – Please make note of your tracking number so that you are able to track it on its way back
                                to us
                            </li>
                        </ul>
                        <p>
                            ...
                            <div class="accordion" id="accordionPanelsStayOpenExample">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            The perfect way to enjoy brewing tea on low hanging fruit to identify. Duis
                                            autem vel eum iriure dolor in hendrerit vulputate velit esse molestie consequat,
                                            vel illum dolore eu feugiat nulla facilisis. For me, the most important part of
