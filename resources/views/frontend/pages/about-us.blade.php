                ...
                <div class="col-sm py-2">
                    <div class="card border-primary shadow radius-15">
                        <div class="card-body">
                            ...
                            <button class="btn btn-sm btn-outline-secondary collapsed" type="button" data-bs-target="#t22_details" data-bs-toggle="collapse" aria-expanded="false">Show Details ▼</button>
