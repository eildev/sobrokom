                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    ...
                                    <input type="email" placeholder="Email" value="" class="email" name="email">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    ...
                                    <input type="text" placeholder="City/Town" value="" class="city" name="city">
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    ...
                                    <input type="text" placeholder="Division" value="" class="division" name="division">
                            ...
                            <div class="order-notes">
                                <div class="checkout-form-list">
                                    ...
                                    <textarea id="checkout-mess" cols="30" rows="10" class="order_notes"
                                        name="order_notes"
                    ...
                    <div class="your-order mb-30 ">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr class="cart-subtotal">
                                        <th>Cart Subtotal</th>
                                        <td><span class="amount">৳ <span class="cart_total">{{ Cart::subtotal()
                                                    }}</span></span></td>
                                    ...
                                    <tr class="cart-subtotal">
                                        ...
                                        <td>
                                            <strong><span class="amount">৳<span
                                                        class="sub_total_with_shiping_amaount">{{ Cart::total()
                                                        }}</span></span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="payment-method">
                            ...
                            <input type="hidden" name="coupon_discount_amount" class="coupon_discount_amount"
                                value="0" />
                            <input type="hidden" name="grand_total_amount" class="grand_total_amount" value="0" />
                        </div>
                    </div>
                </div>
            </div>
