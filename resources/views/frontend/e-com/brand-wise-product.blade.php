                     ...
                     <div class="tpshop__details">
                                 ...
                                 <div class="swiper-slide">
                                    <div class="category__item mb-30">
                                       <div class="category__thumb fix mb-15">
                                          <a href="{{ route('brand.wise.product',$brand->slug) }}"><img src="{{ asset('uploads/brands/'.$brand->image) }}" alt="category-thumb"></a>
                                       </div>
                                       <div class="category__content">
                                          <h5 class="category__title"><a href="{{ route('brand.wise.product',$brand->slug) }}">{{ $brand->BrandName }}</a></h5>
                                       </div>
                                    </div>
                                 </div>
                                 @endforeach
                        ...
                        <div class="basic-pagination text-center mt-35 d-flex justify-content-center">
                            <ul class="pagination">
                                ...
                                @else
                                    <li class="page-item">
                                        <a class="page-link pt-0" href="{{ $allProducts->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">&lsaquo;</a>
                                    </li>
                                @endif
                                ...
                                @foreach ($allProducts->getUrlRange(1, $allProducts->lastPage()) as $page => $url)
                                    @if ($page == $allProducts->currentPage())
                                        <li class="page-item active" aria-current="page"><span class="page-link pt-0">{{ $page }}</span></li>
                                    @else
                                        <li class="page-item"><a class="page-link pt-0" href="{{ $url }}">{{ $page }}</a></li>
                                    @endif
                                @endforeach
                                ...
                                @if ($allProducts->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link pt-0" href="{{ $allProducts->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">&rsaquo;</a>
                                    </li>
                                @else
