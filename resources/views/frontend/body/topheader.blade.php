            ...
            <div class="col-lg-6 col-md-6 d-flex justify-content-center align-items-center top-serch-container" >
                <form class="w-100" action="{{ route('search.product') }}" method="get">
                    ...
                    <div class="input-group" style="position: relative">
                        <input type="text" class="top_search form-control" placeholder="Search for products (e.g. fet food, milk, cat food)" aria-label="Search for products (e.g. fet food, milk, cat food)" aria-describedby="button-addon2" style="border-radius: 0;">
